      ...
      <div className="footer lightgray px-4 ">
        ...
        <div className="row">
          ...
          <div className="col d-flex flex-column flex-md-row justify-content-end mb-2">
            <Link to={'/menu'} className="mt-2 fs-6 text-decoration-none lightgray hover text-md-end">Menu</Link>
            <Link to={'/about'} className="mt-2 fs-6 text-decoration-none lightgray hover mx-md-5 text-md-end">About</Link>
          </div>
        </div>
      </div>
    </>
